...
export function Video({
  ...
  return (
    <video
      ...
      className={className}
      // No GPU hints — @remotion/player's preview <video> passes the author style through
      // untouched. will-change:transform doesn't stop a video layer's integer-pixel snapping
      // (that happens at presentation regardless of promotion); it only adds a snappable seam.
      style={style}
      onCanPlay={onCanPlay}
      onError={onError}
      onSeeking={onSeeking}
