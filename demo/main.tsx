...
createRoot(root).render(
  <div style={{ padding: 28, fontFamily: 'system-ui, sans-serif', color: '#e9e9ee' }}>
    ...
    <div style={{ color: '#8a8a93', fontSize: 13, marginBottom: 20, maxWidth: 520 }}>
      A Remotion-API composition playing in <b>real DOM</b> — video, a Ken Burns push, and a
      <code> backdrop-filter</code> glass caption (arbitrary CSS). This preview <i>is</i> the renderer.
    </div>
